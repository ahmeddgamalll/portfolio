...
"use strict";
    ...
    function ajaxLoader() {
        ...
        var href = $('.ajax-page-load').each(function(){
            ...
            // Use data-id to create unique hash instead of filename
            if(location.hash == location.hash.split('/')[0] + '/project-' + dataId){
        ...
        $(document)
            ...
            .on("click",".ajax-page-load", function () { // Show Ajax Loaded Page
                ...
                var hash = location.hash.split('/')[0] + '/project-' + dataId;
                location.hash = hash;
                showContent();
    ...
    $(window)
        .on('load', function() { //Load
            ...
            // Redirect if old portfolio-project-2 URL is accessed
            if(location.hash && location.hash.indexOf('portfolio-project-2') > -1) {
